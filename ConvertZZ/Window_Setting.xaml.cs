...
namespace ConvertZZ
{
    ...
    public partial class Window_Setting : Window, INotifyPropertyChanged
    {
        ...
        private void LoadSetting()
        {
            ...
            _UseOpenCC = App.Settings.Engine == Enums.Enum_Engine.OpenCC;
        ...
        private void SaveSetting()
        {
            ...
            if (UseOpenCC)
            {
                App.Settings.Engine = Enums.Enum_Engine.OpenCC;
            }
            else if (UseLocalDic)
            {
                App.Settings.Engine = Enums.Enum_Engine.Local;
            }
            else if (UseFanhuajiAPI)
            {
                App.Settings.Engine = Enums.Enum_Engine.Fanhuaji;
            }
            // Unknown case
            else
            {
        ...
        private bool _UseLocalDic, _UseOpenCC, _UseFanhuajiAPI;
        ...
        private void Button_OpenCCSetting_Click(object sender, RoutedEventArgs e)
        {
            new Window_OpenCCSetting().ShowDialog();
        }
        ...
        public bool UseOpenCC { get => _UseOpenCC; set { _UseOpenCC = value; SaveSetting(); } }
